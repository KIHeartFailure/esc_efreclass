pdata <- pdata %>%
  mutate(
    ...
    num_Ef_05cat = factor(case_when(
      ...
      TRUE ~ 2),
      levels = 0:2, labels = c("missing", "5%", "non-5%")
    ),
    ...
    num_dmEflp_cat2 = factor(case_when(
      is.na(num_dmEflp) ~ 0,
      num_dmEflp < 41 ~ 1,
      num_dmEflp <= 49 ~ 2,
      num_dmEflp >= 50 ~ 3
    ...
    num_dmEflp_cat3 = factor(case_when(
    ...
    num_dmEflp_05cat = factor(case_when(
      is.na(num_dmEflp_05) ~ 0,
      num_dmEflp_05 %in% c("0", "5") ~ 1,
      TRUE ~ 2),
      levels = 0:2, labels = c("missing", "5%", "non-5%")
    ),
    ...
    num_Bp1 = case_when(num_dmPtype == "Hospital" ~ num_dcBp1, 
    ...
    num_Bpm = case_when(num_dmPtype == "Hospital" ~ num_dcBpm, 
    ...
    num_mdDiur_c2 = case_when(num_dmPtype == "Hospital" ~ num_mdDiurd_c2, 
                                       num_dmPtype == "Outpatient" ~ num_mdDiurh_c2), 
    num_mdDiur2_c2 = case_when(num_dmPtype == "Hospital" ~ num_mdDiur2d_c2, 
...
#     
    ...
    num_mdDiur = case_when(num_dmPtype == "Hospital" ~ num_mdDiurd, 
                          num_dmPtype == "Outpatient" ~ num_mdDiurh), 
    num_mdACE = case_when(num_dmPtype == "Hospital" ~ num_mdACEd, 
                              num_dmPtype == "Outpatient" ~ num_mdACEh), 
    num_mdAT = case_when(num_dmPtype == "Hospital" ~ num_mdATd, 
                          num_dmPtype == "Outpatient" ~ num_mdATh), 
    num_mdARNI = case_when(num_dmPtype == "Hospital" ~ num_mdARNId, 
    ...
    num_mdAL = case_when(num_dmPtype == "Hospital" ~ num_mdALd, 
                        num_dmPtype == "Outpatient" ~ num_mdALh), 
    
    num_mdBB  = case_when(num_dmPtype == "Hospital" ~ num_mdBBd, 
                           num_dmPtype == "Outpatient" ~ num_mdBBh), 
    num_mdCcb  = case_when(num_dmPtype == "Hospital" ~ num_mdCcbd, 
                          num_dmPtype == "Outpatient" ~ num_mdCcbh), 
    num_mdNit  = case_when(num_dmPtype == "Hospital" ~ num_mdNitd, 
                          num_dmPtype == "Outpatient" ~ num_mdNith), 
    num_mdIvab  = case_when(num_dmPtype == "Hospital" ~ num_mdIvabd, 
                          num_dmPtype == "Outpatient" ~ num_mdIvabh), 
    num_mdDigo  = case_when(num_dmPtype == "Hospital" ~ num_mdDigod, 
                          num_dmPtype == "Outpatient" ~ num_mdDigoh), 
    num_mdAmi  = case_when(num_dmPtype == "Hospital" ~ num_mdAmid, 
                          num_dmPtype == "Outpatient" ~ num_mdAmih), 
    num_mdAntiar  = case_when(num_dmPtype == "Hospital" ~ num_mdAntiard, 
                          num_dmPtype == "Outpatient" ~ num_mdAntiarh), 
    
    num_mdAntipl  = case_when(num_dmPtype == "Hospital" ~ num_mdAntipld, 
                          num_dmPtype == "Outpatient" ~ num_mdAntiplh), 
    num_mdAC  = case_when(num_dmPtype == "Hospital" ~ num_mdACd, 
                          num_dmPtype == "Outpatient" ~ num_mdACh), 
    num_mdStat  = case_when(num_dmPtype == "Hospital" ~ num_mdStatd, 
