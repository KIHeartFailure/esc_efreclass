...
assuming the data followed the respective distributions. A kernel density estimate with a 
smoothing bandwidth of 2 was also computed. All density estimates were 
selected for values between 0 and 100. 
The difference between the observed values and densities was thereafter calculated and summarised. 
