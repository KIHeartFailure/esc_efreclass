...
tab1func(data = pdata %>% filter(num_Ef_cat2 != "Missing EF"), stratavar = "num_Ef_cat2", tabname = "(groups <41, 41-49, >=50)")
```
...
tab1func(data = pdata %>% filter(num_Ef_cat != "Missing EF"), stratavar = "num_Ef_cat", tabname = "(groups <40, 40-49, >=50)")
```
...
tab1func(data = pdata %>% filter(num_Ef_05cat != "Missing EF"), stratavar = "num_Ef_05cat", tabname = "0,5 vs other")
```
