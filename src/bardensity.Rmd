...
matplot(dn * 100, type = "l", col = global_cols[1], add = T, lwd = 2)
matplot(y = dk$y * 100, x = dk$x, type = "l", add = T, col = global_cols[3], lwd = 2)
legend("topright", c("Normal distribution density", "Kernel density"),
  bty = "n", col = c(global_cols[1], global_cols[3]), lwd = 2
)
```
